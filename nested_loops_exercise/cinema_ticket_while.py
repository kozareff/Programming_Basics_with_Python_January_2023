total_students, total_standart, total_kids = 0, 0, 0
...
total_tickets = total_kids + total_standart + total_students

print(f'Total tickets: {total_tickets}')
print(f'{total_students / total_tickets * 100:.2f}% student tickets.')
print(f'{total_standart / total_tickets * 100:.2f}% standard tickets.')
